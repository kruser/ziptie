package ZipTie::Adapters::Juniper::JUNOS::Disconnect;    
...
ZipTie::Adapters::Juniper::JUNOS::Disconnect

=head1 SYNOPSIS

    use ZipTie::Adapters::Juniper::JUNOS::Disconnect;
	ZipTie::Adapters::Juniper::JUNOS::Disconnect::execute($cliProtocol);

=head1 DESCRIPTION

Disconnect method for the CLI of a Juniper router
...
Attempts to disconnect from a Juniper JUNOS device that a CLIProtocol object is currently connected to.
