...
/**
 * The {@link FileServerInfo} represents a simple container to hold basic information about a file server.
...
public class FileServerInfo
{
    ...
    /**
     * Default constructor for the <code>FileServerInfo<code> class.  Creates a new instance and initializes the default
    ...
    /**
     * Constructor for the {@link FileServerInfo} class.  Creates a new instance and initializes its members with
     * the specified parameter.
     * 
     * @param protocol - The name of the protocol that the file server utilizes.
     ...
     */
    public FileServerInfo(String protocol, String ip, int port, String rootDir)
    {
