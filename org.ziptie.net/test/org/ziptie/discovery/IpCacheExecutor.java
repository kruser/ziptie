 ...
 *
 *   $Author: brettw $
 *     $Date: 2007/05/31 18:18:35 $
 * $Revision: 1.2 $
 *   $Source: /usr/local/cvsroot/org.ziptie.net/test/org/ziptie/discovery/IpCacheExecutor.java,v $e
 */
 ...
 * @author rkruse
 */
public class IpCacheExecutor extends ThreadPoolExecutor
{
     ...
     * @param workQueue
     */
    public IpCacheExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue)
    {
