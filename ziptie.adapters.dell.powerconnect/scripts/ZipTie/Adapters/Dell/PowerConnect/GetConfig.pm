package ZipTie::Adapters::Dell::PowerConnect::GetConfig;
...
sub _get_config_tftp
{
	...
	my @responses = ();
	push(@responses, ZipTie::Response->new('[Ee]rror|operation has failed', undef, $TFTP_ERROR));
	push(@responses, ZipTie::Response->new($regex."|completed successfully", \&_finish));
