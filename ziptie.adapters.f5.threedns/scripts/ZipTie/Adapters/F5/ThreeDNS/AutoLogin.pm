package ZipTie::Adapters::F5::ThreeDNS::AutoLogin;
...
ZipTie::Adapters::F5::ThreeDNS::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use ZipTie::Adapters::F5::ThreeDNS;
	my $cli_protocol = ZipTie::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = ZipTie::Adapters::F5::ThreeDNS::execute( $cli_protocol, $connection_path );
