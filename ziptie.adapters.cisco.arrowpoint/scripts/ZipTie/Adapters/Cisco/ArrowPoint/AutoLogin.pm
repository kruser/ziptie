package ZipTie::Adapters::Cisco::ArrowPoint::AutoLogin;
...
ZipTie::Adapters::Cisco::ArrowPoint::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use ZipTie::Adapters::Cisco::ArrowPoint;
	my $cli_protocol = ZipTie::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = ZipTie::Adapters::Cisco::ArrowPoint::execute( $cli_protocol, $connection_path );
