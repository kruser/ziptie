...
package ZipTie::Adapters::Alteon::AD3::Disconnect;
...
# Attempts to disconnect from an Alteon device that a CLIProtocol object is currently connected to.
...
sub _send_exit
{
	...
	my @responses = ();
	push(@responses, ZipTie::Response->new('(#|\$)\s*$', \&_send_exit));
