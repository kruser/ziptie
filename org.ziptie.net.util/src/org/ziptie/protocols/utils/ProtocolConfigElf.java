...
package org.ziptie.protocols.utils;
 ...
 * @author rkruse
 */
public final class ProtocolConfigElf
{
    public static final long DEFAULT_TIMEOUT = 800; // msec
    ...
    /**
     * Private constructor for the <code>ProtocolConfigElf</code> class to disable support of a public default constructor.
     *
     */
    private ProtocolConfigElf()
    {
        // Does nothing.
    }
    ...
    public static ProtocolConfig getNewConfig()
    {
        ...
        snmpProperties.add(new ProtocolProperty(ProtocolConstants.TIMEOUT, Long.toString(DEFAULT_TIMEOUT)));
        snmpProperties.add(new ProtocolProperty(ProtocolConstants.RETRIES, Integer.toString(DEFAULT_MAX_RETRIES)));
